...
const Cart = () => {
   const {products,currency,cartItems,removeFromCart,
    updateCartItem,navigate,getCartTotal,getCartCount} = useAppContext();
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                {cartArray.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        <div className="flex items-center md:gap-6 gap-3">
                            <div 
                            onClick={() => {navigate(`/product/${product.category.toLowerCase()}/${product._id}`); scroll(0, 0);}}
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select 
                                        onClick={(e) => e.updateCartItem(product._id, Number(e.target.value))}
                ...
                <button 
                onClick={() => {navigate('/products'); scroll(0, 0);}} 
